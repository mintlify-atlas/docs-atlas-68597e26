---
title: "Get IntelliPlan Running Locally in Minutes"
...
<Tabs>
  ...
  <Tab title="Google Classroom">
    Google Classroom uses OAuth 2.0. To use it locally you need Google OAuth credentials in your `.env`:
    ...
    Then navigate to **Settings → Integrations → Google Classroom** and click **Connect with Google**.
  </Tab>
