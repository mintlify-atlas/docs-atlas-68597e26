...
<CardGroup cols={2}>
  ...
  <Card title="api_info" icon="circle-info">
...
<Accordion title="api_info">
  **HTTP:** `GET /api/v1/docs`

  No parameters. Returns the IntelliPlan API endpoint catalogue and version string. Call this tool for discovery — it lists all available routes without requiring specific scopes.
</Accordion>
