...
<ResponseField name="spark_balance" type="integer">
...
<ResponseField name="level_title" type="string">
  Display title for the current level (e.g. `"Scholar"`).
</ResponseField>

<ResponseField name="next_level" type="integer">
